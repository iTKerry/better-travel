...
namespace BetterTravel.Poehalisnami.TimerFunction
{
    public class PoehalisnamiProvider : IPoehalisnamiProvider
    {
        ...
        public async Task<List<HotTour>> GetHotToursAsync(PoehalisnamiQuery requestObject)
        {
        ...
        private static PoehalisnamiRequest MapRequest(PoehalisnamiQuery requestObject) =>

...
{
    public class SettingsDeparturesSubscribeCommandHandler : CommandHandlerBase<SettingsDeparturesSubscribeCommand>
    {
        private readonly ITelegramBotClient _telegram;
        
        public SettingsDeparturesSubscribeCommandHandler(
            IUnitOfWork unitOfWork, 
            ITelegramBotClient telegram) : base(unitOfWork) =>
            _telegram = telegram;

        public override async Task<IHandlerResult> Handle(
            SettingsDeparturesSubscribeCommand request, 
            ...
            await UnitOfWork.ChatRepository
                ...
                .Tap(chat => chat.SubscribeToDeparture(DepartureLocation.FromId(request.DepartureId)))

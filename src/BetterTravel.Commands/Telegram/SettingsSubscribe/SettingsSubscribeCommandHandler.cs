...
{
    public class SettingsSubscribeCommandHandler : CommandHandlerBase<SettingsSubscribeCommand>
    {
        private readonly ITelegramBotClient _telegram;

        public SettingsSubscribeCommandHandler(IUnitOfWork unitOfWork, ITelegramBotClient telegram) 
            : base(unitOfWork) =>
            _telegram = telegram;

        public override async Task<IHandlerResult> Handle(
            SettingsSubscribeCommand request, 
